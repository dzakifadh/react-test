	...
	return (
		<div className="relative">
			<div className="flex flex-col items-center justify-center mb-10">
				...
				<div className="grid flex-wrap justify-center grid-cols-2 gap-2 m-4 sm:gap-4 sm:m-10 sm:flex">
					{collection.length > 0 ? (
			...
			<div className={`fixed inset-0 flex items-center justify-center ${isModalShow ? "opacity-1 z-10 visible" : "opacity-0 -z-10 invisible"} bg-opacity-50 bg-slate-900 duration-200`}>
				<div className={`relative overflow-auto rounded-none h-5/6 w-11/12 md:w-3/4 p-6 bg-white text-slate-900 duration-500 ${isModalShow ? "translate-y-0 visible" : "translate-y-20 invisible"}`}>
